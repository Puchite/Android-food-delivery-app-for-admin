...
public class Manage_Drinks extends AppCompatActivity {

    private RecyclerView manage_product;

    private Switch CheckDrinks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manage_drinks);

        DatabaseDrinks = FirebaseDatabase.getInstance().getReference().child("Product").child("Drinks");

        CheckDrinks = findViewById(R.id.ManageProductStatus);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<models, ManageProductViewholder> adapter =
                new FirebaseRecyclerAdapter<models, ManageProductViewholder>(Drink) {
            @Override
                    ...
                    public void onClick(View v) {
                        DatabaseDrinks.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                DatabaseDrinks.child(Position).updateChildren(UpdateStatus);
                            }
                            @Override
    ...
    public void onBackPressed(){
        if(presstime+2000>System.currentTimeMillis()){
            backtoast.cancel();
            startActivity(new Intent(Manage_Drinks.this, ChooseManageProduct.class));
            return;
        }
        else{
